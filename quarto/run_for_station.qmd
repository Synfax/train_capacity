...
The full methodology for how these scores are calculated and why they are important for consideration in upzoning is [here](https://paulspasojevic.com/stations/rankings.qmd).
:::
...
Calculation of the final score for local services uses an index measure. It is described in more detail [here](https://paulspasojevic.com/stations/rankings.html).
