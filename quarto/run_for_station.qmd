...
The full methodology for how these scores are calculated and why they are important for consideration in upzoning is [available in the full report](../quarto/report.html).
:::
:::{.graph}
```{r warning=FALSE,message=FALSE}
#| echo: false 
...
Calculation of the final score for local services uses an index measure. It is described in more detail [in the full report](../quarto/report.html)..
