...
In terms of area, the easiest properties cover `r area_ratio`% of the total area of `r round(sum(by_validity$total_area)/10^6,2)` km^2.
...
(why local amenities are important) 
